...
@Slf4j
@RestController
public class RoleBuObjApiImpl extends BaseApiImpl implements RoleBuObjApi {
    @Autowired
    private RoleBuObjService roleBuObjService;
    ...
    public RestResponse saveRoleBuObj(@RequestBody @Valid RestRequest<RoleBuObjRequestDto> restRequest) {
        ...
        restResponse = roleBuObjService.saveRoleBuObj(restRequest.getBody());
    ...
    public RestResponse getBuObjListByRoleId(Integer roleId) {
        log.info("根据角色查询授权的业务对象列表入参 ："+ roleId);
        RestResponse restResponse = new RestResponse();
        restResponse = roleBuObjService.getBuObjListByRoleId(roleId);
        log.info("根据角色查询授权的业务对象列表出参："+JSON.toJSONString(restResponse));
        return restResponse;
    }
    ...
    public RestResponse getAllBuObjList(Integer roleId) {
        ...
        RestResponse restResponse = new RestResponse();
        restResponse = roleBuObjService.getAllBuObjList(roleId);
    ...
    public RestResponse getBuObjPermissionListByRoleId(@RequestBody @Valid RestRequest<RoleBuObjRequest> restRequest) {
        ...
        RestResponse restResponse = new RestResponse();
        restResponse = roleBuObjService.getBuObjPermissionListByRoleId(restRequest);
    ...
    public RestResponse getUserPermissionByUserId(@Valid RestRequest<UserPermissionRequest> restRequest) {
        ...
        RestResponse restResponse = new RestResponse();
        restResponse = roleBuObjService.getUserPermissionByUserId(restRequest);
